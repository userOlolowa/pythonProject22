...
# Window.size = (512, 512)
# Window.clearcolor = (1 / 255, 1 / 255, 1 / 255, 1)
...
#         super(RootWidget, self).__init__(**kwargs) #непонятная хрень
#
...
#             Color(0, 0, 0, 1)  # black RGBA; colors range from 0-1 not 0-255
...
# class MyApp(App):
#
#     def build(self): #function where you should initialize and return your Root Widget
#         return Label(text='Кто здесь?')
#
#
# if __name__ == '__main__':
#     MyApp().run()
...
#         self.username = TextInput(multiline=False) # штуки посложнее
...
# class MyApp(App):
#
#     def build(self): #в целом можно верхнее просто сюда
#         return LoginScreen()
#
#
# if __name__ == '__main__':
...
import numpy as np
#вдохновляемся добрыми авторами в интернете
...
#      Все объекты мессье на фото
    ...
    def on_touch_down(self, touch):
        ...
        with self.canvas:
            ...
            self.rotation = Rotate(origin=self.center,angle=180)
